...
export const MenuItem = React.forwardRef(
  (
    ...
    // Si deseas controlar el estado del icono, define 'isOpen' aquí
    const [isOpen, setIsOpen] = React.useState(false);  // Aquí defines isOpen
    ...
    // Si deseas que el icono cambie según isOpen, usa isOpen aquí
    const ListIConStyled = styled(ListItemIcon)(() => ({
      ...
      cursor: "pointer",
      marginLeft: "-10px",
      color: isOpen ? "inherit" : "#fff",  // Cambiar según 'isOpen'
    }));

    return (
      <Box>
        <ListItemStyled href={link} sx={{ display: "flex", gap: "15px" }} target={target} selected={link === '/'}>
